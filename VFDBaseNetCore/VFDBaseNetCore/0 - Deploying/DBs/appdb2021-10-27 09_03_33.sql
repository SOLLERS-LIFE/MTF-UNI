...
BEGIN
 ...
 OPTIMIZE TABLE appdb.bs_team_configs;
 ALTER TABLE appdb.bs_team_configs ENGINE=InnoDB, ALGORITHM=INPLACE;
 OPTIMIZE TABLE appdb.sa_user_configs;
 ALTER TABLE appdb.sa_user_configs ENGINE=InnoDB, ALGORITHM=INPLACE;
 
 OPTIMIZE TABLE appdb.bs_teams;
 ALTER TABLE appdb.bs_teams ENGINE=InnoDB, ALGORITHM=INPLACE;
 OPTIMIZE TABLE appdb.bs_team_marks;
 ALTER TABLE appdb.bs_team_marks ENGINE=InnoDB, ALGORITHM=INPLACE;
 OPTIMIZE TABLE appdb.bs_team_users;
 ALTER TABLE appdb.bs_team_users ENGINE=InnoDB, ALGORITHM=INPLACE;
 OPTIMIZE TABLE appdb.bs_invite_traps;
 ALTER TABLE appdb.bs_invite_traps ENGINE=InnoDB, ALGORITHM=INPLACE;
  
 OPTIMIZE TABLE appdb.bs_marks;
 ALTER TABLE appdb.bs_marks ENGINE=InnoDB, ALGORITHM=INPLACE;
 OPTIMIZE TABLE appdb.bs_marks_to_users;
 ALTER TABLE appdb.bs_marks_to_users ENGINE=InnoDB, ALGORITHM=INPLACE;
 
 OPTIMIZE TABLE appdb.bs_objects_protocol;
 ALTER TABLE appdb.bs_objects_protocol ENGINE=InnoDB, ALGORITHM=INPLACE;
