...
namespace MTF.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<CommonUser> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!await _userManager.IsInRoleAsync(await _userManager.FindByNameAsync(Input.Email), "SUS"))
                    {
                        _logger.LogWarning($"User {Input.Email} refuser because of the system is closed.");
                        return RedirectToPage("./sysClosed");
                    }
                }
                ...
                {
                    ModelState.AddModelError(string.Empty, $"Invalid login attempt {Input.Email}.");
                    return Page();
                }
            }
